...
<details>
  ...
  **Neste projeto, seu grupo deve desenvolver um app de delivery para uma distribuidora de bebidas. Veja abaixo o contexto da entrega que deve ser feita:**
  ...
  Sua equipe, que já possui uma boa experiência com desenvolvimento, em pouco tempo apresentou um [protótipo](hhttps://www.figma.com/file/K5QMj8tHzs8ZX3cL1y8Vqh/T20_Project_Delivery_App?node-id=0%3A1) e um [Diagrama de ER](./assets/readme/eer.png) conforme imagem:
...
<details>
  ...
  - Utilize esse [protótipo](hhttps://www.figma.com/file/K5QMj8tHzs8ZX3cL1y8Vqh/T20_Project_Delivery_App?node-id=0%3A1) para se guiar na construção do front-end. Esse arquivo é comentado com os nomes de cada elemento.
...
- Se oriente pela seguinte tela do protótipo: [`Comum / Login`](hhttps://www.figma.com/file/K5QMj8tHzs8ZX3cL1y8Vqh/T20_Project_Delivery_App?node-id=0%3A1);
...
- Se oriente pela seguinte tela do protótipo: [`Comum / Cadastro`](hhttps://www.figma.com/file/K5QMj8tHzs8ZX3cL1y8Vqh/T20_Project_Delivery_App?node-id=0%3A1);
...
- Se oriente pela seguinte tela do protótipo: [`Comum / Produtos`](hhttps://www.figma.com/file/K5QMj8tHzs8ZX3cL1y8Vqh/T20_Project_Delivery_App?node-id=0%3A1);
...
- Se oriente pela seguinte tela do protótipo: [`Comum / Checkout`](hhttps://www.figma.com/file/K5QMj8tHzs8ZX3cL1y8Vqh/T20_Project_Delivery_App?node-id=0%3A1);
...
- Atente-se que, no [protótipo](hhttps://www.figma.com/file/K5QMj8tHzs8ZX3cL1y8Vqh/T20_Project_Delivery_App?node-id=0%3A1), a tela `Cliente / Detalhes do Pedido` possui a data do pedido:
...
- Se oriente pela seguinte tela do protótipo: [`Comum / Meus Pedidos`](hhttps://www.figma.com/file/K5QMj8tHzs8ZX3cL1y8Vqh/T20_Project_Delivery_App?node-id=0%3A1);
...
- Se oriente pela seguinte tela do protótipo: [`Comum / Detalhes do Pedido`](hhttps://www.figma.com/file/K5QMj8tHzs8ZX3cL1y8Vqh/T20_Project_Delivery_App?node-id=0%3A1);
...
- Se oriente pela seguinte tela do protótipo: [`P. Vend / Pedidos`](hhttps://www.figma.com/file/K5QMj8tHzs8ZX3cL1y8Vqh/T20_Project_Delivery_App?node-id=0%3A1);
- Os `data-testid` desses itens devem terminar com o `id` de cada venda no banco. Por exemplo: 
...
- Se oriente pela seguinte tela do protótipo: [`P. Vend / Detalhes do Pedido`](hhttps://www.figma.com/file/K5QMj8tHzs8ZX3cL1y8Vqh/T20_Project_Delivery_App?node-id=0%3A1);
...
- Se oriente pela seguinte tela do protótipo: [`P. Adm. / Gerenciamento`](hhttps://www.figma.com/file/K5QMj8tHzs8ZX3cL1y8Vqh/T20_Project_Delivery_App?node-id=0%3A1);
